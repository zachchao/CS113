...
public class Student implements Comparable<Student>{
	...
	/**
	 * Equals method for testing if two students are equal
	 * @param other The other student to test for equality
	 * @return A boolean denoting if the two students are equal to one another.
	 */
	@Override
	public boolean equals(Object other){
		if(((Student)other).getClass().equals(this.getClass())){
			if(this.first.equals(((Student) other).getFirst())){
				if(this.last.equals(((Student) other).getLast())){
					return true;
				}
			}
		}
